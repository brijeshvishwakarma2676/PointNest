...
/**
 * PointsHistory - PointNest Enterprise Edition
      ...
      <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8 animate-in fade-in slide-in-from-top-4 duration-700">
        <div>
          ...
          <p className="text-gray-500 font-medium max-w-md text-sm leading-relaxed">
            Verify point allocations, audit redemption events, and maintain a
            verifiable record of all loyalty events across the enterprise.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-[2.5rem] border border-gray-200 overflow-hidden shadow-2xl shadow-gray-200/50">
              <div className="px-10 py-10">
                <div className="mb-8">
                  <h2 className="text-xs font-black text-gray-900 uppercase tracking-[0.2em] mb-2">
                    Protocol Lookup
                  </h2>
                  <p className="text-sm text-gray-400 font-medium font-sans">
                    Query customer ledger by primary terminal phone number.
                  </p>
                </div>
                        ...
                        ledger.map((item) => (
                          ...
                          >
                                ...
                                <div
                                  className={`h-11 w-11 rounded-2xl flex items-center justify-center transition-all ${
                                    item.type === "earn"
                                      ...
                                      : "bg-[#0A0A0B] text-white shadow-lg shadow-gray-200"
                                  }`}
                                >
                                  {item.type === "earn" ? (
                            ...
                            <td className="px-10 py-7 text-right">
                              <span
                                className={`text-xl font-black tracking-tighter ${item.type === "earn" ? "text-gray-900" : "text-gray-400"}`}
                              >
                                {item.type === "earn" ? "+" : "-"}
                                {item.points}
                              </span>
          ...
          <div className="bg-white rounded-[2.5rem] border border-gray-200 overflow-hidden shadow-2xl shadow-gray-200/50">
            <div className="px-10 py-8 border-b border-gray-100 flex items-center justify-between bg-gray-50/30">
              <div>
                ...
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">
                  Real-time ledger of point outflows
                </p>
              </div>
            </div>
                ...
                <tbody className="divide-y divide-gray-50">
                  {shopLoading ? (
                    ...
                    <tr>
                      <td
                        colSpan="3"
                        className="px-10 py-32 text-center text-gray-300 font-bold uppercase tracking-widest italic opacity-60"
                      >
                        ...
                        <td className="px-10 py-7">
                          <div className="flex flex-col">
                            ...
                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1">
                              ₹{red.amount_discounted} DISC AUTH
                            </span>
                          </div>
                        </td>
                        <td className="px-10 py-7 text-right">
            ...
            {!shopLoading &&
              ...
              shopPagination.total > shopPagination.size && (
                <div className="px-10 py-8 bg-gray-50/30 border-t border-gray-100 flex items-center justify-between">
                  <div className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">
                    INDEX {shopPagination.page} /{" "}
                    {Math.ceil(shopPagination.total / shopPagination.size)}
                  </div>
                  <div className="flex gap-3">
                    <button
                      disabled={shopPagination.page === 1}
                      onClick={() =>
                        fetchShopRedemptions(shopPagination.page - 1)
                      }
                      className="px-5 py-3 rounded-xl bg-white border border-gray-200 text-gray-900 text-xs font-bold hover:shadow-md transition-all disabled:opacity-30"
                    >
                      <ChevronLeft size={16} />
